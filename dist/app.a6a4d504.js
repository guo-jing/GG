...
!function (s) {
  ...
  !function (t) {
    ...
    } else document.attachEvent && (c = t, o = s.document, n = !1, i = function i() {
      n || (n = !0, c());
    }, (_l = function l() {
      try {
    ...
    var t, e, c, o, n, i;
    (t = document.createElement("div")).innerHTML = l, l = null, (e = t.getElementsByTagName("svg")[0]) && (e.setAttribute("aria-hidden", "true"), e.style.position = "absolute", e.style.width = 0, e.style.height = 0, e.style.overflow = "hidden", c = e, (o = document.body).firstChild ? (n = c, (i = o.firstChild).parentNode.insertBefore(n, i)) : o.appendChild(c));
  });
}(window);
